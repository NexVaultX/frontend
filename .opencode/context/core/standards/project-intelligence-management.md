...
> **What**: How to manage project intelligence files and folders. **When**: Use this guide when adding, updating, or removing intelligence files. **Related**: See `project-intelligence.md` for what and why.
