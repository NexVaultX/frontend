...
const TabsTrigger = ({ className, ...props }: TabsPrimitive.Tab.Props) => (
  <TabsPrimitive.Tab
    ...
    className={cn(
      "data-selected:bg-background data-selected:text-foreground focus-visible:ring-ring inline-flex min-h-9 flex-1 items-center justify-center gap-2 rounded-lg px-4 text-sm font-medium whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:outline-none data-selected:shadow-sm sm:flex-none",
      className
    )}
    {...props}
  />
